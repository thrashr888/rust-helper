...
use commands::{
    ...
    clean_project, clean_projects, get_cache, get_default_scan_root, get_favorites, get_hidden,
    get_recent_projects, get_scan_root, run_cargo_bench, run_cargo_build, run_cargo_check,
    run_cargo_clippy, run_cargo_command, run_cargo_doc, run_cargo_fmt_check, run_cargo_run,
