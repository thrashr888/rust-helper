...
use commands::{
    ...
    detect_installed_ides, estimate_clean_sizes, generate_docs, get_binary_sizes,
    get_build_processes, get_cache, get_cargo_features, get_default_scan_root, get_disk_space,
    get_favorites, get_git_info, get_git_stats, get_git_tags, get_github_actions_status,
    get_hidden, get_msrv, get_preferred_ide, get_recent_projects, get_rust_version_info,
    get_scan_root, get_workspace_info, global_search, install_tool, open_file_in_ide,
    open_file_in_vscode, open_in_finder, open_in_ide, open_in_vscode, parse_nextest_junit,
    read_cargo_toml, read_tarpaulin_results, restart_build_process, run_cargo_bench,
    ...
    scan_projects, set_favorite, set_hidden, set_preferred_ide, set_scan_root, stop_build_process,
    upgrade_homebrew, upgrade_rust_homebrew,
};
