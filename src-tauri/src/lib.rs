...
use commands::{
    ...
    get_default_scan_root, get_favorites, get_git_info, get_git_stats, get_git_tags,
    get_github_actions_status, get_hidden, get_msrv, get_recent_projects, get_rust_version_info,
    get_scan_root, get_workspace_info, global_search, install_tool, open_file_in_vscode,
    ...
    run_cargo_tree, run_cargo_update, read_tarpaulin_results, save_audit_cache,
